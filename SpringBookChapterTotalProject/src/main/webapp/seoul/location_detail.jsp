...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    ...
    <div class="content two_quarter first"> 
      <!-- ################################################################################################ -->
      <h1>${vo.title }</h1>
      <img src="${vo.poster }" width=120%>
      <p><pre style="white-space:pre-wrap;border:none;backgroud-color:white">${vo.msg }</pre></p>
      <p>주소:${vo.address }</p>
      <div id="comments">
        <h2>Comments</h2>
        <ul>
    ...
    <div class="text-right">
     <a href="../seoul/location_list.do" class="btn btn-sm">명소 목록</a>
    </div>
    <div class="clear"></div>
  </main>
</div>
