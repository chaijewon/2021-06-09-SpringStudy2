       ...
       <table class="table">
         <tr>
          <td class="text-center" width=30% rowspan="2">
            <a href="chef_make.do?chef=${vo.chef }"><img src="${vo.poster }" width=110 height=110 class="img-circle"></a>
          </td>
          <td colspan="4"><h3 style="color:orange"><a href="chef_make.do?chef=${vo.chef }">${vo.chef }</a></h3></td>
         </tr>
         <tr>
